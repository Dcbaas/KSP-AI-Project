...
class RocketData:
    ...
    def __init__(self, connection):
        ...
        self.position = connection.add_stream(self.vessel.position, self.mun_target.reference_frame)
        self.CARTESIAN_POS = np.array(
            self.mun_target.surface_position(DEST_LOC[0], DEST_LOC[1], self.mun_target.reference_frame))
    ...
    def asses_fligh(self) -> bool:
        ...
        if self.vessel.met > 10 and self.vessel.situation == self.vessel.situation.pre_launch:
            return False
